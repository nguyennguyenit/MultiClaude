...
**Input:** external-srs.md from Gemini Deep Research
```markdown
# Task Management App Requirements

## User Authentication
Users should be able to login with email/password or OAuth...

## Task Creation
Users can create tasks with title, description, due date...

## Dashboard
Show task statistics, upcoming deadlines...
```
...
- **Priority:** P1
- **Description:** Users should be able to login with email/password or OAuth
- **Source:** External SRS "User Authentication"

## FR-002: Task Creation
- **Priority:** P1
- **Description:** Users can create tasks with title, description, due date
- **Source:** External SRS "Task Creation"

## FR-003: Dashboard
- **Priority:** P2
- **Description:** Show task statistics, upcoming deadlines
- **Source:** External SRS "Dashboard"
```
