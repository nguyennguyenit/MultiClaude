...
AI-facing guidance for Codex with IPA (Japan Standard) documentation workflow.

---

## ARCHITECTURE NOTE

**v1.3.0:** Skills-based architecture. All IPA functionality is implemented as skills in `.Codex/skills/`.
...
**Before `/plan*`:** Read `.Codex/workflows/multi-model-task-distribution.md`
...
- Workflow: `.Codex/workflows/multi-model-task-distribution.md`
- Skills: `.Codex/skills/`
