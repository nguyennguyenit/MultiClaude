...
export function GitPanel({ projectPath, isOpen, onToggle }: GitPanelProps) {
  ...
  return (
    <div className="w-80 bg-[var(--mc-bg-secondary)] border-l border-[var(--mc-border)] flex flex-col">
      {/* Header */}
      <div className="px-3 py-2 border-b border-[var(--mc-border)]">
        ...
        {/* Actions Row: Sync/Pull/Push + Branch Selector */}
            ...
            {hasRemote && (
              <>
                <button
                  onClick={handleSync}
                  disabled={syncing}
                  className="p-1 hover:bg-[var(--mc-bg-hover)] rounded disabled:opacity-50"
