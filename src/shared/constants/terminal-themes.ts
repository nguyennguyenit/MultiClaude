...
export const TERMINAL_THEMES: Record<`${ColorTheme}-${'dark' | 'light'}`, ITheme> = {
  ...
  'tokyo-night-light': {
    background: '#f8fafc', foreground: '#0f172a', cursor: '#315fba',
    cursorAccent: '#f8fafc', selectionBackground: '#dbeafe',
    selectionForeground: '#0f172a',
    ...ANSI_COLORS.light
  },
  ...
  'catppuccin-light': {
    background: '#f8fafc', foreground: '#0f172a', cursor: '#365ea8',
    cursorAccent: '#f8fafc', selectionBackground: '#e0e7ff',
    selectionForeground: '#0f172a',
    ...ANSI_COLORS.light
  },
  ...
  'dracula-light': {
    background: '#f8fafc', foreground: '#0f172a', cursor: '#7650a8',
    cursorAccent: '#f8fafc', selectionBackground: '#ede9fe',
    selectionForeground: '#0f172a',
    ...ANSI_COLORS.light
  },
  ...
  'rose-pine-light': {
    background: '#f8fafc', foreground: '#0f172a', cursor: '#76568f',
    cursorAccent: '#f8fafc', selectionBackground: '#f3e8ff',
    selectionForeground: '#0f172a',
    ...ANSI_COLORS.light
  },
